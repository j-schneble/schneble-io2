    ...
    <div className="flex flex-col items-center justify-center px-4 pt-6 mb-8 space-y-3 text-center  md:px-16">
         ...
         <Image
                src='/../public/pr.png'
                 ...
                 alt='Summary image'
             />
                <h1 className="mt-5 ml-1 cursor-default text-3xl antialiased leading-none tracking-wider text-left text-black/95 dark:text-white/95 font-sfprodisplayregular">
                   Primo
                </h1>
          ...
          <Link 
          isExternal 
          href='https://github.com/j-schneble/pr-service-pa'			
