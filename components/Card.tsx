  ...
  const Cardx: React.FC<CardxProps> = ({ title, cardDescription, image, modalDescription, repoUrl, dispUrl }) => {
    ...
    return (
        <>
          ...
          <Card
           isFooterBlurred 
           className="overflow-hidden rounded-xl border border-zinc-800/10 bg-gradient-to-b from-zinc-950 via-#0e0e0e to-zinc-950 shadow-md transition-all hover:-translate-y-0.5 hover:shadow-xl"
          >
            <div
              className=
              "aspect-[5/2] w-full rounded-t-xl bg-zinc-200"
            />
